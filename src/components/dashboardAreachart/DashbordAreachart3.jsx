    ...
    <div className="w-full">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <div className="px-4 my-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
              <path opacity="0.6" d="M47.28 29.8062C44.0745 42.6634 31.0515 50.4874 18.1927 47.2819C5.33999 44.0765 -2.48476 31.0534 0.721486 18.1969C3.92549 5.3382 16.9477 -2.4873 29.8027 0.718197C42.6607 3.9237 50.4847 16.9482 47.2792 29.8062H47.28Z" fill="#F71AEE"/>
            </svg>
          </div>
        ...
        <div className="flex">
          ...
          <p>%</p>
          <div className="px-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#9747FF">
      ...
      <div className="flex justify-center">
        <img src={linechartpurple} alt="" className="w-[40rem] h-[8rem]" />
      </div>
...
export default DashbordAreachart3;
