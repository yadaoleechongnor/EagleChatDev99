...
function Productdetail() {
  ...
  return (
    <div className=" mt-24 w-full">
      ...
      <div className=" flex justify-center w-full border shadow-lg rounded-b-lg ">
        <div className=" w-full flex justify-around mt-12">
          <div className=" text-center text-2xl font-medium w-[22%] flex flex-col justify-center items-center">
            <h1> TAEKO Cleansing Foam & Serum Liquid Foundation </h1>
            <img src={rectangle} alt="" className=" w-60 h-68 rounded-lg" />
            <h1>450 Point</h1>
          </div>
          <div className=" w-[60%]  flex flex-col justify-center">
            <div className=" flex justify-around items-center border w-[90%] text-2xl  h-[6rem] rounded-2xl bg-sky-200 ">
              <div className="flex flex-col justify-center items-center">
                <h1 className=" text-gray-500">ຍອດຂາຍ</h1>
                <h1 className=" text-lg font-medium">150</h1>
              </div>
              ...
              <div className=" flex flex-col items-center justify-center ">
                ...
                <div className=" flex gap-4 items-center justify-center">
                  <FaKipSign />
                  <h1 className=" text-lg font-medium">150000</h1>
                </div>
              </div>
            </div>
            <div className=" w-[90%] flex flex-col my-6 ">
              <h1 className=" text-xl font-medium  mt-4">ລາຍລະອຽດສີນຄ້າ</h1>
              <div className=" w-full text-lg">
                <li className=" ml-4">
                ครีมบำรุงผิวหน้านวัตกรรมพิเศษให้ผิวกระจ่างใสลดเลือนรอยหมองคล้ำขนาด 30 มิลลิลิตร.
                </li>

                <li className=" ml-4">
                ວັນທີຜະລິດ: 12/03/2022 ,ວັນທີໝົດອາຍຸ: 12/03/2023ช่วยให้ผิวดูสว่างกระจ่างใสลดการก่อตัวของความหมองคล้ำและผิวเสียสะสม
                </li>

                <li className=" ml-4">
                ช่วยบำรุงผิวทำให้ผิวอิ่มน้ำมีความชุ่มชื้นอย่างเป็นธรรมชาต
                </li>

                <li className=" ml-4">
                ช่วยเพิ่มความแข็งแรงให้กับผิว ฟื้นบำรุงผิวอ่อนแอแพ้ง่าย
                </li>
                ...
                <li className=" ml-4">
                ວິທີໃຊ້ : ทาครีม หลังการทำความสะอาดผิวหน้า ทุกๆเช้าและก่อนเข้านอน
                </li>
              </div>
              <div className=" flex gap-6 self-end items-center ">
                ...
                <NavLink to="/productorder">
                  <button className=" border text-white font-medium bg-blue-light h-12 w-40 rounded-lg">
                    ເລືອກສີນຄ້າ
                  </button>
                </NavLink>
              </div>
