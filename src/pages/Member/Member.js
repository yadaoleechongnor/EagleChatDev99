	...
	return (
		<div className=' mt-[6rem] w-full flex justify-center '>
			<div className=' flex  w-[96%]  flex-col my-8'>
				<div className=' flex justify-between items-center h-[5rem] w-full bg-gradient-to-b from-blue-dark to-blue-light rounded-xl '>
					<div className=' flex px-6 gap-6'>
						<div className=' w-48 flex justify-center items-center bg-white h-10 rounded-lg text-blue-light font-bold '>
							<span>ສະແດງຕາມລຳດັບ</span>
						</div>
						<NavLink to="/membertable" className=' w-48 flex justify-center items-center bg-sky-400 h-10 rounded-lg text-white font-bold '>
					...
					<div className=' flex items-center gap-8 mr-10'>
						...
						<div className='flex items-center h-10  bg-white rounded-lg w-80 '>
							<IoSearch className="px-2 h-10 w-10 text-blue-dark"/>
							<input type="text" name="" id="" className="outline-none" placeholder=" ຄົ້ນຫາສະມາຊິກ "/></div>
						<button className=' border bg-[#00628A] rounded-lg w-28 h-10 text-white font-bold'>ຄົ້ນຫາ</button>
					</div>
				</div>
            ...
            {/*  ======================    member information ================= */}
					...
					<div className=' absolute w-[15rem] gap-3 font-medium text-sm flex flex-col items-center   h-[33rem] flex flex-col  mt-[-39.5rem] ml-[59rem]  '>
						<div className=' w-full bg-white rounded-lg shadow-lg  flex justify-center  '>
							<div className=' flex flex-col gap-2 my-1 w-[95%]  '>
								<span className=' my-2 '>
									ລະຫັດສະມາຊິກ 220111</span>
								<div className=' flex gap-2 '>
									<span>
										ຊື່ທຸລະກິດ</span>
									<span>
										KHONESAVANH SINGMA</span>
								</div>
								<div className=' flex gap-2  '>
                ...
                <div className=' flex '>
                  <div className=' w-[10rem]'>
                    <span>ຮັກສາຍອດເດືອນປັດຈຸບັນ</span>
                  </div>
                  <span>0 PV</span>
                </div>
                ...
                <div className=' flex '>
                  <div className=' w-[10rem]'>
                    <span>ຮັກສາຍອດເດືອນທີ່ແລ້ວ</span>
                  </div>
                  <span>0 PV</span>
                </div>
            ...
            <div className=' flex w-full bg-white justify-center flex  rounded-lg shadow-lg  '>
              <div className=' w-[90%] '>
                <div className=' w-full'>
